...
If data is not already streaming, the Bluemuse app will be launched and the
user must manually connect the Muse and click on "Start Streaming"
"""
import subprocess
from pylsl import StreamInfo, StreamInlet, resolve_stream, resolve_bypred

# *signals: the signals to obtain from the muse. Any combination of "EEG",
# "PPG", "Accelerometer", "Gyroscope". If unspecified, obtains all of these.
def main(*signals):
