...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\HP User\\source\\repos\\attention-monitoring\\src\\data_collection\\gradCPT.py',
    ...
    for thisTrial in trials:
        ...
        while continueRoutine and routineTimer.getTime() < 1.2000000000000002:
            ...
            if transitioning_stimulus.status == STARTED:
                # update params
                transitioning_stimulus.setOpacity(t/STIM_TRANSITION_TIME, log=False)
